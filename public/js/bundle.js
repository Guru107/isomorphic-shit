...
module.exports = Item = React.createClass({displayName: "Item",
	...
	render:function(){
		return (
			...
			React.createElement("h2", null, "Yayyy!!, Isomorphic!!"), 
			React.createElement("div", {id: "controls"}, 
			React.createElement("button", {onClick: this._decrement, className: "btn btn-default"}, "-"), 
			React.createElement("div", null, this.state.count), 
			React.createElement("button", {onClick: this._increment, className: "btn btn-primary"}, "+")
			)
			)
			)
			)
...
},{"./Item":2,"react":158}],4:[function(require,module,exports){
/**
